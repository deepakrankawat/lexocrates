...
export const blogPosts = [
  {
    ...
    fullContent: `
      ...
      <h2>Benefits of Outsourcing Legal Work to India:</h2>
      ...
      <p>As global legal teams increasingly seek leaner operations and high-quality support, the Indian LPO sector is poised to be a crucial partner in delivering value-driven legal solutions. For firms aiming to enhance productivity and profitability, India remains a premier destination for legal outsourcing.</p>
    `
  },
  {
    id: 2,
    ...
    fullContent: `
      ...
      <h3>1. Professionalism and Quality Delivery</h3>
      ...
      <h3>2. Skilled Talent at Scale</h3>
  ...
  },
  {
    ...
    fullContent: `
      ...
      <ul class="list-disc list-inside">
        ...
        <li><strong>Employee Training:</strong> Every member of our team undergoes rigorous training on data privacy, confidentiality agreements, and client-specific security protocols.</li>
        <li><strong>Regular Audits:</strong> We conduct regular internal and external security audits to identify and address potential vulnerabilities, ensuring our defenses are always up-to-date.</li>
      </ul>
