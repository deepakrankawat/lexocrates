...
export const blogPosts = [
  ...
  },
  {
    ...
    fullContent: `
      ...
      <p>Navigating the maze of zoning laws requires careful planning and expert guidance. The team at Northman Law has extensive experience in real estate and land use law. We can assist you with due diligence, applications for variances and rezoning, and representation before local government bodies. Our goal is to help you overcome regulatory hurdles and bring your real estate vision to life, ensuring compliance with all local and state regulations.</p>
    `,
  },
  {
    id: 5,
