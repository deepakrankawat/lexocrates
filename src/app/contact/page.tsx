...
export default function ContactPage() {
  ...
  return (
    <main className="bg-background">
      ...
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden bg-primary py-12 lg:py-20">
        ...
        <div className="relative z-10 mx-auto w-full px-6 sm:px-12 lg:px-24 fhd:px-32 max-w-[1800px] text-center">
          <div className="max-w-4xl mx-auto">
            <FadeIn delay={0.1}>
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-white/70 font-medium leading-relaxed max-w-2xl mx-auto">
      ...
      <div className="mx-auto w-full px-6 sm:px-12 lg:px-24 max-w-[1400px] fhd:max-w-[1600px] qhd:max-w-[1800px]">
          ...
          <section id="contact-form" className="py-16 lg:py-32">
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
              <div className="space-y-12">
                <div>
                  <h2 className="font-lato text-3xl sm:text-5xl font-black text-primary tracking-tight mb-8">
                    Let&apos;s Start a <span className="text-accent">Conversation</span>
                  </h2>
                  <p className="text-lg sm:text-xl text-foreground/60 font-medium leading-relaxed border-l-4 border-accent/10 pl-8">
              ...
              <div className="bg-secondary/30 p-8 sm:p-12 rounded-[2.5rem] lg:rounded-[3.5rem] border border-black/5 shadow-sm hover:shadow-2xl transition-all duration-500 group">
                <SimpleContactForm />
              </div>
            </div>
          </section>
          ...
          <section className="py-12 lg:py-16">
            <div className="bg-primary rounded-[2.5rem] lg:rounded-[4rem] p-10 sm:p-20 overflow-hidden relative group">
          ...
          <section id="headquarters" className="py-16 lg:py-32">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-center">
                <div className="lg:col-span-1">
                   ...
                   <div className="p-8 bg-secondary rounded-[2rem] border border-black/5">
                      <p className="text-xs font-black text-primary uppercase tracking-widest mb-4">Visit Us At</p>
                ...
                <div className="lg:col-span-2">
                  <div className="relative h-[350px] sm:h-[500px] lg:h-[600px] w-full overflow-hidden rounded-[2.5rem] lg:rounded-[3.5rem] shadow-2xl border-4 lg:border-8 border-secondary/50 group">
                    <iframe
