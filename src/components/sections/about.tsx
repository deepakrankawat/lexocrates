        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <SlideIn direction="up" delay={0.2}>
            <h2 className="font-lato text-4xl sm:text-6xl lg:text-7xl font-black text-primary leading-[1.1] mb-10 tracking-tighter">
              Your Strategic Partner <br /> in <span className="text-accent">Legal Intelligence</span>
            </h2>
          </SlideIn>
          ...
          <p className="text-xl sm:text-2xl text-foreground/60 leading-relaxed font-medium mb-16 max-w-3xl mx-auto border-l-4 sm:border-l-0 border-accent/20 pl-8 sm:pl-0 text-left sm:text-center">
              Lexocrates was founded to bridge the gap between high-quality legal services and cost-effective operational management. We empower law firms in the US, UK, and Canada to achieve more by acting as a high-fidelity, India-based extension of their internal legal teams.
          </p>
