...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary pt-20">
      ...
      <div className="relative z-10 mx-auto w-full px-6 sm:px-12 lg:px-24 max-w-[1800px] py-32 text-center lg:text-left">
        <div className="max-w-6xl mx-auto lg:mx-0">
          ...
          <SlideIn direction="up" delay={0.4} duration={0.8}>
            <h1 className="font-montserrat text-5xl sm:text-7xl lg:text-[9rem] font-black leading-[0.85] text-white mb-14 tracking-tighter">
              Strategic <br />
          ...
          <FadeIn delay={0.6} duration={0.8}>
            <p className="max-w-3xl text-xl sm:text-2xl lg:text-3xl text-white/70 font-medium leading-relaxed mb-16 mx-auto lg:mx-0 border-l-4 border-accent/20 pl-8">
          ...
          <FadeIn delay={0.8} duration={0.8}>
            <div className="flex flex-col sm:flex-row items-center gap-8 justify-center lg:justify-start">
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto bg-accent text-accent-foreground hover:bg-white hover:text-primary font-montserrat font-black text-xl px-14 py-10 rounded-full shadow-[0_20px_50px_rgba(206,166,48,0.2)] transition-all duration-500 hover:scale-105 active:scale-95"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="w-full sm:w-auto bg-white/5 backdrop-blur-md text-white border-white/20 hover:bg-white hover:text-primary font-montserrat font-black text-xl px-14 py-10 rounded-full transition-all duration-500 hover:scale-105 active:scale-95"
              >
      ...
      {/* Bottom status bar */}
      <div className="absolute bottom-12 left-6 lg:left-24 hidden md:flex items-center gap-6 opacity-30">
