...
export function Welcome() {
  const founderImage = PlaceHolderImages.find(img => img.id === 'lawyer-5');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
          ...
          <div className="relative group">
            <div className="relative z-10 w-full aspect-square max-w-[500px] mx-auto">
              ...
              <div className="relative h-full w-full rounded-[4rem] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.12)] border-8 border-white group-hover:scale-[1.02] transition-transform duration-700">
                {founderImage && (
                    <AppImage
