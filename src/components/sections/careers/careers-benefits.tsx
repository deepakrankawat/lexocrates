...
const benefits = [
  {
    ...
    description:
      'We invest in your professional development with continuous training.',
  },
  {
    icon: Laptop,
  ...
  },
  {
    ...
    description:
      'We offer flexible work schedules to promote a healthy work-life balance.',
  },
];
        ...
        <StaggerFadeIn className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map(benefit => (
            <div key={benefit.title} className="text-center p-6">
              ...
              <h3 className="font-roboto text-2xl font-medium text-primary">
                {benefit.title}
              </h3>
